...
function ConsoleButton({
  ...
  return html`
    <div className=${`relative rounded-lg surface-hardware-well p-[2.5px] shrink-0 ${className}`}>
      <button
        aria-label=${label}
        title=${label}
...
export function AudioConsoleModal({
  ...
  return html`
    <div className="fixed inset-0 bg-void/95 backdrop-blur-md z-[110] flex items-center justify-center p-4 cursor-none animate-lightbox-entry">
      <div className="relative w-full max-w-5xl bg-panel-raised rounded-lg shadow-[0_20px_50px_rgba(0,0,0,0.8)] border border-[#3a3a40] overflow-hidden flex flex-col cursor-none">
        
        <div className="flex items-center justify-between px-5 md:px-8 py-4 border-b shrink-0 w-full relative z-20 transition-colors duration-300 bg-void/40 border-white/10">
          <div className="flex items-center gap-3 text-primary-400">
            <${Settings2} size=${22} />
            <h2 className="text-md md:text-lg font-display font-bold uppercase tracking-wider mt-0.5 text-white">
              AUDIO CONSOLE
            </h2>
          </div>
          <button 
        ...
        <div className="p-6 flex flex-col gap-6 overflow-y-auto max-h-[85vh] custom-scrollbar" data-lenis-prevent="true">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center md:items-stretch bg-[#111114] p-5 rounded-xl border border-white/5 shadow-inner">
            ...
            <div className="flex-1 w-full flex flex-col justify-between gap-4 md:gap-0 min-w-0">
              <div className="flex justify-between items-start">
                <div className="min-w-0 flex-1">
                  <span className="text-[10px] font-mono font-bold tracking-widest text-primary-400 uppercase select-none">
                    // ACTIVE SOURCE FEED
                  </span>
                  
                  <div class="mt-1 pb-1">
                    <div className="text-light font-display font-bold text-xl md:text-2xl lg:text-3xl truncate leading-tight pb-1 drop-shadow-md">
                      ${cleanTitle}
                    </div>
                    <div className="text-[11px] md:text-xs font-mono tracking-widest uppercase truncate leading-none pb-1 text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-cyan-400 to-indigo-400 bg-[length:200%_auto] animate-gradient-xy">
                      ${cleanAlbum}
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-center gap-2.5 w-full">
                <div className="relative flex items-center group/scrub flex-1 h-6">
                ...
                <div className="flex items-center justify-center font-mono text-[11px] text-muted border border-transparent surface-hardware-track rounded-md shrink-0 px-3 min-w-[110px] h-6 bg-[#0c0d11]">
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-stretch w-full">
            ...
            <div class="w-full lg:flex-1 shrink-0 bg-panel rounded-xl border border-white/5 shadow-inner flex flex-col overflow-hidden h-[380px]">
              <div className="flex items-center justify-between px-3 py-3 border-b border-white/10 shrink-0 z-10 bg-ink select-none">
                <span className="font-display font-bold text-sm text-light tracking-widest uppercase ml-1">
                  Global Mixer
                </span>
                <div className="flex items-center gap-2">
                  <button 
                    onClick=${handleResetMixer}
                    className="flex items-center gap-2 px-3 py-1 bg-white/5 rounded-md text-[10px] font-mono text-fog transition-colors cursor-none border border-white/10 hover:border-primary-400 hover:text-primary-400 outline-none h-8"
                  >
                    RESET
                  </button>
                  <button 
